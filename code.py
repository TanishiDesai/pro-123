import cv2 #read csv file
import numpy as np #performing numerical python operations
import pandas as pd #reading data files
import seaborn as sns #data visualisation
import matplotlib.pyplot as plt #cool graphs
from sklearn.datasets import fetch_openml #getting data from ml(ml contains datasets)
from sklearn.model_selection import train_test_split  #split data into training and testing data
from sklearn.linear_model import LogisticRegression #training algorithm 
from sklearn.metrics import accuracy_score #check the accuracy
from PIL import Image #PIL python imaging library; image editing capabilites 
import PIL.ImageOps #ImageOps = image operation
import os, ssl, time #os = operating system; ssl = secure socket layer
